...
WebUI.click(findTestObject('Object Repository/Page_React  TodoMVC/a_Completed'))

WebUI.click(findTestObject('Object Repository/Page_React  TodoMVC/button_Clear completed'))
